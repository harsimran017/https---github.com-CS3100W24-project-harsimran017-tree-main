...
import { GameDataAccess } from '../repositories/gamedata.js'
import { GameController } from '../controllers/stockcontroller.js'
import {
	checkAuth,
	isAdmin,
	notFound,
...
const gameRepository = new GameDataAccess(gameModel)
